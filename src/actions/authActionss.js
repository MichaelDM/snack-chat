...
//           console.log('user credential is ', user.credential);
//           console.log('credential is', credential);
//           // console.log('accesstoken? ', user.credential.accessToken);
//           console.log('localstorage is ', JSON.parse(localStorage.getItem('firebase:authUser:AIzaSyAQvkE7GVByKSirN-3IMsm1EI0QHEFQjnY:[DEFAULT]')));
//           const profile = {
